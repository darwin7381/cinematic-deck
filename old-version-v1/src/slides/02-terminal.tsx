          ...
          <>
            ...
            <div
              className={`relative z-10 h-full ${
                isPortrait
                  ? 'flex flex-col gap-10 px-[70px] py-[130px]'
                  : 'grid grid-cols-2 gap-20 px-[140px] py-[120px]'
              }`}
            >
              {/* Copy */}
              <div className={`flex flex-col justify-center ${isPortrait ? '' : ''}`}>
                <motion.div
                  ...
                  className={`font-mono tracking-[0.4em] text-cyan-300/70 uppercase ${
                    isPortrait ? 'text-base mb-6' : 'text-xs mb-8'
                  }`}
                >
                  08 · Scripted Terminal
                </motion.div>
                ...
                <motion.h2
                  ...
                  className={`font-bold leading-[1] tracking-[-0.03em] text-white ${
                    isPortrait ? 'text-[92px] mb-6' : 'text-[88px] mb-10'
                  }`}
                >
                  Fake CLI,<br />
                ...
                <motion.p
                  ...
                  className={`text-white/50 leading-relaxed font-light ${
                    isPortrait ? 'text-xl max-w-full' : 'text-xl max-w-[480px]'
                  }`}
                >
                  Hand-crafted typing sequences, arbitrary delays, colored output.
                  Same technique LivePPT fakes — but you own the code.
                </motion.p>
              </div>
              ...
              >
                ...
                <div className={isPortrait ? 'flex-1 p-6' : 'flex-1 p-8'}>
                  <FakeTerminal
                    active={active}
                    lines={[
