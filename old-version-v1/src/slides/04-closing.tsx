        ...
        return (
          <>
            <div className="absolute inset-0">
              <Canvas camera={{ position: [0, 0, 5], fov: isPortrait ? 60 : 50 }} dpr={[1, 2]}>
            ...
            <div className={`relative z-10 h-full flex flex-col items-center justify-center text-center ${isPortrait ? 'px-10' : 'px-20'}`}>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 1.2 }}
                className={`font-mono tracking-[0.4em] text-pink-300/70 uppercase ${isPortrait ? 'text-base mb-14' : 'text-xs mb-10'}`}
              >
                Now ship yours.
              </motion.div>
              ...
              <motion.h2
                ...
                className={`font-bold leading-[0.9] tracking-[-0.05em] ${isPortrait ? 'text-[180px] mb-14' : 'text-[180px] mb-12'}`}
                style={{
              ...
              <motion.div
                ...
                className={`font-mono text-white/40 tracking-wider ${isPortrait ? 'text-sm' : 'text-sm'}`}
              >
