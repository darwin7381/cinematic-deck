...
export default function Hero01({ onStepsChange }: {
  ...
  return (
    <Slide background="linear-gradient(135deg, #0a0a1f 0%, #1a0a2e 50%, #0f0520 100%)">
      ...
      <CursorGradient color="rgba(232, 121, 249, 0.35)" size={700} />
      <div className="noise" />
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-[140px]">
        <motion.div
          ...
          className="font-mono text-sm tracking-[0.4em] text-pink-300/70 mb-8 uppercase"
        >
          Cinematic Deck Starter · 2026
        </motion.div>
        ...
        <motion.h1
          ...
          className="text-[140px] font-bold leading-[0.95] tracking-[-0.04em] mb-10"
          style={{
        ...
        <motion.p
          ...
          className="text-2xl text-white/60 max-w-[720px] leading-relaxed font-light"
        >
        ...
        <motion.div
          ...
          className="absolute bottom-[80px] right-[140px] flex items-center gap-3 font-mono text-xs text-white/40 tracking-widest"
        >
