...
export default function Problem02({ onStepsChange }: {
  ...
  return (
    <Slide background="linear-gradient(135deg, #1a0a2e 0%, #2d0b3f 100%)">
      <CursorGradient color="rgba(236, 72, 153, 0.25)" size={600} />
      <div className="noise" />

      <div className="relative z-10 h-full flex flex-col justify-center px-[140px]">
        <motion.div
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 1 }}
          className="font-mono text-xs tracking-[0.4em] text-rose-300/60 mb-8 uppercase"
        >
          02 · The question
        </motion.div>
        ...
        <motion.h2
          ...
          className="text-[128px] font-bold leading-[0.95] tracking-[-0.04em] mb-10 text-white"
        >
          But everyone
          <br />
          <span
        ...
        >
          <p className="text-3xl text-white/70 font-light leading-relaxed">
            LivePPT 的 viral 影片聲稱一個工具能生成
            <span className="text-rose-300"> cinematic hero demo</span>。
          </p>
          <p className="text-xl text-white/50 font-light leading-relaxed max-w-[920px]">
        ...
        <motion.div
          ...
          className="absolute bottom-[90px] right-[140px] font-mono text-xs text-white/30 tracking-[0.3em]"
        >
